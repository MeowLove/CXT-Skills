...
This v3 provider operations file merges and organizes the previous stable-path and provider-mismatch field notes. It intentionally keeps the field-tested command blocks because these paths are fragile and have caused real deployment failures.
