...
- Current Orca resolves WSL/SSH agent paths past shell aliases/functions. Use normal LeanCTX onboarding, then verify `claude`, `codex`, and `cc-switch` from Orca's actual WSL launcher environment.
